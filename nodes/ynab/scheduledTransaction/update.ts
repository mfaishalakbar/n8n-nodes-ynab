...
const showFor = { resource: ['scheduledTransaction'], operation: ['update'] };
...
export const scheduledTransactionUpdateDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		default: '',
		displayOptions: { show: showFor },
		description: 'The date for this scheduled transaction (ISO format: YYYY-MM-DD)',
		routing: {
			send: {
				type: 'body',
